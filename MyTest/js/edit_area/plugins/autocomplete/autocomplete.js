...
var EditArea_autocomplete= {
	...
	init: function(){	
		...
		editArea.load_css(this.baseURL+"css/incra_autocomplete.css");
		editArea.load_script(this.baseURL+"incra_autocomplete.js");
		
		
	}
	,loadXmlList	:	function(){
		var url = window.location.host + "incra_class_list.xml";
		$.ajax({
			type: "GET",
			url: url,
			dataType: "xml",
